...
psql -c "copy (select a.name as nom1, b.name as nom2,
  st_x(st_centroid(st_collect(st_intersection(a.wkb_geometry, b.wkb_geometry)))) as lat,
  st_y(st_centroid(st_collect(st_intersection(a.wkb_geometry, b.wkb_geometry)))) as lon
